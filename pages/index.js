  ...
  return (<>
    <Layout contentMaxWidth="none">
      ...
      <div className={classes.centerHorizontal} style={{width:'100%'}}>
        {videoPlaying == "cloudRiskVideo" && <video controls playsInline style={{maxWidth: 700, width:"100vw",boxShadow:"0px 0px 10px #333"}} id="videoEl" preload>
        ...
        {videoPlaying == "promoVideo" &&<video controls playsInline style={{maxWidth: 700, width:"100vw",boxShadow:"0px 0px 10px #333"}} id="videoEl" preload>
